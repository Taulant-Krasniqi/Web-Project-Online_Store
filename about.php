        ...
        <div class="team">
            ...
            <div class="card">
                <div class="circle-containerr">
                    <h1 style="color:#fff;"><img class="photo" src="img/taulanti.jpg"></h1>
                </div>
                <h2>Taulant Krasniqi</h2>
            ...
            <div class="card">
                <div class="circle-containerr">
                    <h1 style="color:#fff;"><img class="photo" src="img/floriani.jpg"></h1>
                </div>
                <h2>Florian Azemi</h2>
                <h4>Full-Stack Developer</h4>
                <p>Inspired By Buddha.</p>
            </div>
            ...
            <div class="card">
                <div class="circle-containerr">
                    <h1 style="color:#fff;"><img class="photo" src="img/liridon.png"></h1>
                </div>
                <h2>Liridon Hasani</h2>
                <h4>Full-Stack Developer</h4>
                <p>The Punisher. </p>
            </div>
        </div>
